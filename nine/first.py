...
iris_df = pd.read_csv("/home/ivanbalashov/LearningMachine/nine/Iris.csv", index_col="Id") 
...
plt.savefig('homework_nine_nine_nine.png', dpi=300, bbox_inches='tight')
plt.close()